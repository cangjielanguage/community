...
- 邮件正文
  ...
  **推举概述示例：**
  ...
  ```
  本人现任xxx_Team Committer，gitcode_id (email address) 提名 gitcode_id (email address) 为 repository_address仓的社区Committer。
  ...
  **退出概述示例：**
  ...
  ```
  本人现任xxx_Team Committer，由于工作变动/xx等原因，申请退出 xxx 仓库committer。
  ```
  ...
  **贡献举证：**
  ...
  - **参与技术峰会**：
    20xx年 参加仓颉语言开发者大会、仓颉语言技术峰会、开放原子全球开源峰会的 **《XXX议题》**
