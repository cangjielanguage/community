...
|Stand Libs Team| 标准库技术领域竞争力分析和关键技术识别，功能分解分配，模块间接口定义与维护管理，对应领域特性代码开发维护等; <br/>负责标准库领域系统设计方案的技术评审，技术决策，模块关键技术问题解决; <br/>负责标准库技术领域的社区需求技术规划和梳理对应领域的共建需求梳理; <br/>代表标准库技术领域参加仓颉社区的峰会和布道。|
