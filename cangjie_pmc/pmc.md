...
|StandLibs Team| 标准库技术领域竞争力分析和关键技术识别，功能分解分配，模块间接口定义与维护管理，对应领域特性代码开发维护等; <br/>负责标准库领域系统设计方案的技术评审，技术决策，模块关键技术问题解决; <br/>负责标准库技术领域的社区需求技术规划和梳理对应领域的共建需求梳理; <br/>代表标准库技术领域参加仓颉社区的峰会和布道。|
...
| QA Team | QA团队的目标是负责社区开发、治理、运营等流程规范的制定和发布；制定社区奖惩机制，例行跟踪社区运营问题。|
| 测试 Team | 构建社区测试能力，让更多的社区开发者参与、贡献构建仓颉编程语言测试能力；根据版本计划制定测试计划、规划测试活动，看护版本关键软件包质量；参与制定、维护发布标准，参与管理发布过程，决策阻塞问题和关键缺陷的修复计划。|
...
| 刘天瑜 | [@BestLeon](https://gitcode.com/bestleon) | PMC成员 | Test Team             |
